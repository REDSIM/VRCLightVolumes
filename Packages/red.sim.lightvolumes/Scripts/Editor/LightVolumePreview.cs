...
namespace VRCLightVolumes {
    ...
    static class SceneLightVolumeDebugModes {
        ...
        static class Shaders {
            ...
            internal static readonly Shader Overdraw = Shader.Find("Hidden/LV_DebugDisplayOverdraw");
        }
        ...
        static readonly SceneView.CameraMode OverdrawMode;
        ...
        static SceneLightVolumeDebugModes() {
            ...
            OverdrawMode = SceneView.AddCameraMode("VRCLV Overdraw", Section);
        ...
        static void ApplyMode(SceneView view, SceneView.CameraMode mode) {
            ...
            else if (mode == OverdrawMode) shader = Shaders.Overdraw;
            else {
